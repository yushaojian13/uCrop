 ...
 */
open class GestureCropImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : CropImageView(context, attrs, defStyle) {

    private val mScaleDetector: ScaleGestureDetector
    private val mRotateDetector: RotationGestureDetector
    ...
    init {
        mGestureDetector = GestureDetector(this.context, GestureListener(), null, true)
        mScaleDetector = ScaleGestureDetector(this.context, ScaleListener())
